 ...
 * The internal virtual interface conforms the extensible and modifiable surface of crowdsales. Override
...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    /**
     * @dev Override for extensions that require an internal virtual state to check for validity (current user contributions,
     * etc.)
     * @param beneficiary Address receiving the tokens
     * @param weiAmount Value in wei involved in the purchase
     */
